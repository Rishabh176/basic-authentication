                    ...
                    <Card body outline color="success" className="mx-auto my-2 card">
                        ...
                        <Form.Group>
                            ...
                            <Form.Group>
                                <Row className="justify-content-md-center pt-1">
                                    <Col>
                                        <Button variant="outline-primary" size="lg" type="submit" className="mr-4">Sign Up </Button>
                                        <Button variant="outline-warning" type="submit" size="lg"  onClick={this.handleSubmitlogin}>Log In </Button>
                                    </Col>                           
                                </Row>
                            </Form.Group>
